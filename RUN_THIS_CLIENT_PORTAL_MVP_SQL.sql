-- Co Pilot Collections Manager - Client / Portfolio Owner Portal MVP R7 (DEMO)
-- Run in the matching DEMO Supabase SQL Editor before uploading/testing the R7 ZIP.
